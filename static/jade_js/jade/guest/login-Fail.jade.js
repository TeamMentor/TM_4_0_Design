...
jade_mixins["alert"] = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div role=\"alert\" class=\"alert\">Login failed</div>");
};
...
jade_mixins["login-form"] = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<h3 id=\"login\">Login</h3>\n<p>Already have an account? Sign in here.</p>\n<form id=\"login-form\" role=\"form\" method=\"post\" action=\"/user/login\"><div class=\"form-group\"><label for=\"new-user-username\">Username</label><input id=\"new-user-username\" type=\"username\" name=\"username\" placeholder=\"Username\" class=\"form-control\"/></div><div class=\"form-group\"><label for=\"new-user-password\">Password</label><input id=\"new-user-password\" type=\"password\" name=\"password\" placeholder=\"Password\" class=\"form-control\"/></div><button type=\"submit\" id=\"btn-login\">Login</button><br/><br/><a href=\"returning-user-forgot-password.html\"><button type=\"button\" id=\"btn-forgot-pwd\">Forgot your password?</button></a><br/><br/></form>");
};
