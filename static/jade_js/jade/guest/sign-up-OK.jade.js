...
buf.push("</ul></div></div></div><div id=\"application\"><div class=\"row\"><div class=\"column-3\"><div class=\"lge-container\"><br></div></div><div class=\"column-6\"><div class=\"lge-container\"><h3>Welcome to TEAM Mentor</h3><p>Thank you for creating a new account.</p><p>Please<a href=\"/user/login/returning-user-login.html\"> Login</a></p></div></div></div></div></body></html>");;return buf.join("");
}