...
buf.push("</ul></div></div></div><div id=\"application\"><div class=\"row\"><div class=\"column-3\"><div class=\"lge-container\"><br></div></div><div class=\"column-6\"><div class=\"lge-container\"><br><h3>Ok, Done</h3><p>We've sent you an email with instructions for resetting your password.</p></div></div></div></div></body></html>");;return buf.join("");
}