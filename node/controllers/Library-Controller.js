    ...
    {        
        ...
        this.showLibraries = function() 
            {       
                ...
                this.res.send(this.jade_Service.renderJadeFile('/static/jade/user/list.jade', viewModel));
            };
                    ...
                    this.mapLibraryData(library, function()
                        {
                            ...
                            that.res.send(that.jade_Service.renderJadeFile('/static/jade/user/library.jade', viewModel));
                        });
            ...
            request(server + url, function(error, response,data)
                {
                    ...
                    that.res.send("that.jade_Service.renderJadeFile('/static/jade/user/queries.jade', viewModel)");
                    //that.res.send(nodes)
                });            
        };
                    ...
                    this.mapLibraryData(library, function()
                        {
                            ...
                            if (folder)
                            {
                                var viewModel = { libraries : that.libraries , 
                                              library   : library,
                                              folder    : folder};
                                that.res.send(that.jade_Service.renderJadeFile('/static/jade/user/folder.jade', viewModel));
                            }
                            else
