...
{    
    ...
    {        
        ...
        expect(renderJadeFile(helpJadeFile                 )).to.contain    ('<a href="/landing-pages/about.html">About</a>'); 
        expect(renderJadeFile(helpJadeFile,{loggedIn:false})).to.contain    ('<a href="/landing-pages/about.html">About</a>'); 
        expect(renderJadeFile(helpJadeFile,{loggedIn:true })).to.not.contain('<a href="/landing-pages/about.html">About</a>'); 
